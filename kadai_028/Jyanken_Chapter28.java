...
public class Jyanken_Chapter28 {
	...
	public String getRandom() {
		...
		yourHandIndex = (int)Math.floor(Math.random() * 2);
	...
	public void playGame() {
		...
		if (myHand == "r"&yourHand == "r" || myHand == "s"&yourHand =="s"||myHand =="p"&yourHand=="p" ) {
			System.out.println("あいこです");
		} else if (myHand == "r"&yourHand == "s" || myHand == "s"&yourHand =="p"||myHand =="p"&yourHand=="r" ) {
				System.out.println("自分の勝ちです");
		} else if (myHand == "r"&yourHand == "p" || myHand == "s"&yourHand =="r"||myHand =="p"&yourHand=="s" ){
